...
class Oder
{
    ...
    #[ORM\ManyToOne(inversedBy: 'oders')]
     ...
     */
    #[ORM\OneToMany(targetEntity: OrderProducts::class, mappedBy: 'oder', orphanRemoval: true)]
    ...
    public function removeOrderProduct(OrderProducts $orderProduct): static
    {
        if ($this->orderProducts->removeElement($orderProduct)) {
            ...
            if ($orderProduct->getOder() === $this) {
                $orderProduct->setOder(null);
            }
        }
